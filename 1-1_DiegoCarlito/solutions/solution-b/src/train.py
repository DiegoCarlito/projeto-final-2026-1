...
def build_pipeline(categorical_cols: list, numerical_cols: list) -> Pipeline:
    ...
    class_weight="balanced" compensa o desbalanceamento de classes do dataset
    (bem menos clientes com Churn=Yes do que Churn=No) — ver project-context.md §2.
    """
...
def train_model():
    ...
    print("Iniciando treino do modelo Random Forest (Solution B)...")
